...
from ecoface_lite.api.routers import alerts, cameras, detections, experimental, health, historical, incidents, live_test, nvr, observability, persons, processing, sites, stream, zones
