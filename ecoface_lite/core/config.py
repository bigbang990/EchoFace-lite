...
class Settings(BaseSettings):
    ...
    face_quality_small_face_size: int = Field(default=30, ge=1, alias="FACE_QUALITY_SMALL_FACE_SIZE")
    face_quality_blurry_face_size: int = Field(default=60, ge=1, alias="FACE_QUALITY_BLURRY_FACE_SIZE")
    ...
    detector_min_score: float = Field(default=0.60, ge=0, le=1, alias="DETECTOR_MIN_SCORE")
    detector_high_quality_threshold: float = Field(default=0.60, ge=0, le=1, alias="DETECTOR_HIGH_QUALITY_THRESHOLD")
